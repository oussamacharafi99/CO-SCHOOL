...
@Component({
  ...
  templateUrl: './dash-admin-get-absences.component.html',
  styleUrls: ['./dash-admin-get-absences.component.css']
})
export class DashAdminGetAbsencesComponent  implements OnInit {
