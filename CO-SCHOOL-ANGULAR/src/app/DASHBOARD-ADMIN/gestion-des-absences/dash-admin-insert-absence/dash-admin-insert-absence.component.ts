...
@Component({
  ...
  templateUrl: './dash-admin-insert-absence.component.html',
  styleUrls: ['./dash-admin-insert-absence.component.css']
})
export class DashAdminInsertAbsenceComponent implements OnInit{
