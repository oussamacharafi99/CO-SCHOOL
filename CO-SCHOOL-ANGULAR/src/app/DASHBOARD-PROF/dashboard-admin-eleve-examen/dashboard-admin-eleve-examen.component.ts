...
@Component({
  selector: 'app-dashboard-admin-eleve-examen',
  templateUrl: './dashboard-admin-eleve-examen.component.html',
  styleUrls: ['./dashboard-admin-eleve-examen.component.css']
})
export class DashboardAdminEleveExamenComponent implements OnInit {
